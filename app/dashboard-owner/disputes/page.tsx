    ...
    <div className="space-y-6 pb-20">
      ...
      <header className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-neutral-500 font-medium mt-1">Raise issues against tenants or respond to claims filed against you.</p>
        </div>
      </header>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-2xl">
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-neutral-200 shadow-2xs">
                ...
                <form onSubmit={handleRaiseDispute} className="space-y-5">
                  <div>
                    <label className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-1.5">Related Property / Tenant</label>
                    <select 
                      required
                  ...
                  <div>
                    ...
                    <input 
                      required type="text" placeholder="e.g. Broken window during move-out"
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
              {activeCases.length === 0 ? (
                <div className="bg-neutral-50 border border-dashed border-neutral-200 rounded-2xl p-10 flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-neutral-400 mt-1">Your portfolio is peaceful.</p>
                </div>
              ) : (
